...
const Testmonial = () => {
    ...
    return (
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 pt-20 pb-30">
            <Title title="What Our Customers Say" subtitle="Discover why our customers love us! Read their testimonials and see how we've made a difference in their car rental experience." align={"left"} />
